...
[姿态与工作面总览](poses.png)。灰色是物体，绿色是工作面，橙圈是实际地面接触点；每行给出姿态、工作面视角、接地点放大图。

| Case | 目标姿态 | 工作面 / 物体总表面积 |
|---|---|---:|
| [pose_1](pose_1/pose.png) | 原始倾斜姿态，保留原工作面 | 10.18% |
| [pose_2](pose_2/pose.png) | 另一侧倾斜，改用另一片工作面 | 9.17% |
| [pose_3](pose_3/pose.png) | 倒立，耳 A 的耳尖着地 | 10.45% |
| [pose_4](pose_4/pose.png) | 另一倾角倒立，耳 B 的耳尖着地 | 10.96% |
...
各姿态都不穿地面、只有一个顶点落在 y=0；工作面连通，占总面积的 8%–15%，所有工作面朝上的法向分量大于 0.35，面中心沿外法向的射线不与物体相交。新姿态的工作面全部顶点离地大于 1.5 mm。完整 30° 力锥内的逐载荷可达性由后续 Step1 检查。
