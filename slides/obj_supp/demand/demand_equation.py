...
def main():
    ...
    text(x, .592, r'$(F_D,\tau_D)=\left(mg\,\hat y-F_{\rm push},\;-(\mathrm{pt}-c)\times F_{\rm push}\right)$', 25)
    ...
    text(x, .301, r'$\sum_{\rm heads}F_{\rm supp}\cdot\hat y\geq0$', 27)
    ...
    text(.5, .137, 'pt: push location; c: center of mass; '
         ...
         r'$0\leq|F_{\rm push}|\leq0.5\,mg$; y points upward.', 16)
